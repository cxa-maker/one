	...
	return []IntegrationConfigSchema{
		{
			...
			Fields: []IntegrationFieldSchema{
				...
				}, Help: "当前默认文本 AI 服务商；各服务商 API Key 独立存储"},
				{Name: "openai_api_key", Label: "OpenAI API Key", Type: "password", Required: false, Sensitive: true},
				{Name: "openai_base_url", Label: "OpenAI Base URL", Type: "text", Required: false, Placeholder: "https://api.openai.com/v1"},
				{Name: "openai_model", Label: "OpenAI 默认模型", Type: "text", Required: false, Placeholder: "gpt-4o-mini"},
				{Name: "openai_compatible_api_key", Label: "OpenAI Compatible API Key", Type: "password", Required: false, Sensitive: true},
				{Name: "openai_compatible_base_url", Label: "OpenAI Compatible Base URL", Type: "text", Required: false},
				{Name: "openai_compatible_model", Label: "OpenAI Compatible 默认模型", Type: "text", Required: false},
				{Name: "deepseek_api_key", Label: "DeepSeek API Key", Type: "password", Required: false, Sensitive: true},
				{Name: "deepseek_base_url", Label: "DeepSeek Base URL", Type: "text", Required: false, Placeholder: "https://api.deepseek.com/v1"},
				{Name: "deepseek_model", Label: "DeepSeek 默认模型", Type: "text", Required: false, Placeholder: "deepseek-chat"},
				{Name: "qwen_api_key", Label: "通义千问 API Key", Type: "password", Required: false, Sensitive: true},
				{Name: "qwen_base_url", Label: "通义千问 Base URL", Type: "text", Required: false, Placeholder: "https://dashscope.aliyuncs.com/compatible-mode/v1"},
				{Name: "qwen_model", Label: "通义千问默认模型", Type: "text", Required: false, Placeholder: "qwen-plus"},
				{Name: "api_key", Label: "API Key（legacy）", Type: "password", Required: false, Sensitive: true, Help: "已废弃；请使用各服务商独立 api_key 字段。读取时仍作为回退。"},
				{Name: "base_url", Label: "Base URL（legacy）", Type: "text", Required: false, Help: "已废弃；请使用各服务商独立 base_url 字段"},
				{Name: "model", Label: "默认模型（legacy）", Type: "text", Required: false, Help: "已废弃；请使用各服务商独立 model 字段"},
		...
		},
		{
			...
			GroupKey:    "pricing",
			Fields: []IntegrationFieldSchema{
				{Name: "default_markup_type", Label: "默认加价方式", Type: "text", Required: false, Help: "percent / fixed / multiplier / none", DefaultValue: "percent"},
				...
				{Name: "default_markup_multiplier", Label: "默认加价倍率", Type: "number", Required: false, DefaultValue: 1.5},
				{Name: "default_shipping_cost", Label: "默认固定运费成本", Type: "number", Required: false, DefaultValue: 0},
				{Name: "default_shipping_cost_per_weight", Label: "默认按重量运费单价", Type: "number", Required: false, DefaultValue: 0},
				{Name: "default_platform_commission_percent", Label: "默认平台佣金（%）", Type: "number", Required: false, DefaultValue: 0},
				{Name: "default_min_profit", Label: "默认最低利润", Type: "number", Required: false, DefaultValue: 0},
				{Name: "default_exchange_rate", Label: "默认汇率", Type: "number", Required: false, DefaultValue: 1},
				{Name: "default_rounding_mode", Label: "默认尾数", Type: "text", Required: false, Help: "none / integer / .9 / .99 / .95 / 9.99 / 19.90", DefaultValue: ".99"},
